Get SMS for your Customers events into your Message box when no internet.

## Overview
Using Twilio SMS you'll get all your Customers events using SMS into your Message inbox. This is one time process to configure webhook for the Customers events.
...
6. Now go to your Shopify Admin Panel click on Apps in the left nav then select Connectify and Setup webhooks for the  **Customer** apps using Message. 
