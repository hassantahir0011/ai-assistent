Get SMS for your Product events into your Message box when no internet.

## Overview
Using Twilio SMS you'll get all your Products events using SMS into your Message inbox. This is one time process to configure webhook for the Products events.
...
6. Now go to your Shopify Admin Panel click on Apps in the left nav then select Connectify and Setup webhooks for the  **Product** apps using Message. 
