Manage all your Locales (languages) event to Slack App.

## Overview
Using this Slack event you can change language of the store easily and track your events in it. This is one time process to keep track on all the events need to get all details on your store.
...
6. Now go to your shopify admin panel click on Apps in the left nav then select Connectify and Setup webhooks for the  **ShopAlternateLocale** apps. 
