var Login = function () {
    var e = function () {
        ...
        jQuery().select2 && $("#country_list").size() > 0 && ($("#country_list").select2({
            ...
            messages: {"g-recaptcha-response": {required: "Please verify yourself by captcha."}},
            invalidHandler: function (e, r) {
            },
            highlight: function (e) {
                $(e).closest(".form-group").addClass("has-error")
            ...
            errorPlacement: function (e, r) {
                ...
                "g-recaptcha-response" == r.attr("name") ? e.insertAfter($("#register_grecaptcharesponse_error")) : 1 === r.closest(".input-icon").size() ? e.insertAfter(r.closest(".input-icon")) : e.insertAfter(r)
            },
            submitHandler: function (e) {
                e[0].submit()
            }
