var total_selected_grading_type = [];
(function ($) {
        ...
        fSelect.prototype = {
            ...
            reloadDropdownLabel: function () {
                ...
                if (labelText.length < 1) {
                    ...
                    if ($.inArray('ALL', total_selected_grading_type) != -1) {
                        labelText = settings.overflowText.replace('{n} selected','All ' );
                    }else{
                        labelText = settings.overflowText.replace('{n}', total_selected_grading_type.length+1);
