...
use App\Services\ProcessWebhooks;
...
class ProcessInventoryItemLevelWebhooks implements ShouldQueue
{
    ...
    public function __construct(
        ...
        $shop, $event_topic,
        $shopify_request_header,$event_name
    )
    {
    ...
    public function handle()
    {
        ...
        $trigger_webhook = new ProcessInventoryItemLevelWebhooksLib(
