    ...
    <div class="container">
        ...
        <div class="bodyContent">
            <div class="bodyText">
                ...
                <ul>
                    <li>You recently removed the {{ config('app.name') }} App from your website. Your subscription has been automatically canceled as well. We are sorry to see you go, and would like to thank you for being with us. There could be various reasons for leaving and we really hope you can help us learn and improve.</li>
