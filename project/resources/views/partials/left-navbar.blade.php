<div class="left-menu-section left-menu-collapes" id="">
    ...
    <ul class="nav flex-column flex-nowrap overflow-hidden ">
        ...
        <li class="nav-item"><a class="nav-link text-truncate" href="{{ route('products') }}"><i class="fa fa-history menu-icons" aria-hidden="true"></i> <span class=" menu-text">Products</span></a></li>
